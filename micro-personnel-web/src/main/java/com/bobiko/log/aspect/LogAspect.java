...
public class LogAspect
{
    ...
    @Pointcut("@annotation(com.bobiko.log.annotation.Log)")
    public void LogAnnotationPointcut() {}

    @Before(value = "LogAnnotationPointcut()")
    public void beforeLogAnnotationPointcut() {
    ...
    public void getControllerMethodDescription(JoinPoint joinPoint, Log log, SysOperLog operLog, Object jsonResult) throws Exception
    {
        ...
        {
            operLog.setJsonResult(StrUtil.sub(jsonResult.toString(),0,2000));
        }
    }
    ...
    private void setRequestValue(JoinPoint joinPoint, SysOperLog operLog) throws Exception
    {
        ...
        if (HttpMethod.PUT.name().equals(requestMethod) || HttpMethod.POST.name().equals(requestMethod))
        {
            ...
            String param = getArgsArrayToString(ServletUtils.getRequest().getQueryString());
            if (StrUtil.isNotEmpty(param)){
                operLog.setOperParam(StrUtil.sub(param, 0, 2000));
            }
        }
    }
     ...
     * @return
     */
    private String getArgsArrayToString(String param){
        if (StrUtil.isEmpty(param)) return null;
        ...
        if (paramsArray != null && paramsArray.length > 0)
        {
            for (Object o : paramsArray)
            {
                if (ObjectUtil.isNotEmpty(o) && !isFilterObject(o))
                {
                    try
                    {
                        Object jsonObj = new JSONObject(o);
